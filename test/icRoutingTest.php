...
class icRoutingTest extends PHPUnit_Framework_TestCase {
	/*
	 * icRouter instance
	*/
	private $oRouter; 
	
	private function matchUrlOk($url, $params) {
	...
	public function setUp() {
		...
		$this->oRouter->addRoutes ( array (				
				new icRoute ( 'photo', '/photo/:action/:id-:name/:delete', array (
						'module' => 'photo',
						'action' => 'index',
						'id' => 0,
						'delete' => 0,
				...
				new icRoute ( 'video', '/video/:action/:id-:name/*', array (
						'module' => 'video',
						'action' => 'index' 
				), array (
						'action' => $oRPWord,
				...
				new icRoute ( 'module_action', '/:module/:action/*', array (
						'action' => 'index' 
				), array (
						'module' => $pRPNotIn,
						'action' => $oRPWord 
